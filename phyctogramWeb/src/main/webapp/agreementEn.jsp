...
<head>
 <meta charset="utf-8" />
  <title>Phyctogram-partnership</title>
...
제1조(목적) 이 약관은 (주)나리지식앤컴퍼니(이하 “회사”라 한다)가 운영하는 픽토그램 앱(이하 “앱”이라 한다)에서 제공하는 모바일 서비스(이하 “서비스”라 한다)를 이용함에 있어 앱과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

제2조(정의)

  ① “앱”이란 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 휴대폰 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말합니다.
...
제3조 (약관 등의 명시와 설명 및 개정) 
  ...
  ① 회사는 이 약관의 내용을 회원이 쉽게 확인 할 수 있도록 서비스 초기화면에 게시하며 이 약관은 '서비스'에 게시하거나 기타의 방법으로 회원에게 공지함으로써 효력이 발생합니다.

  ② 회사는 합리적인 사유가 발생할 경우 온라인 디지털콘텐츠산업 발전법, 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제에 관한 법률, 소비자기본법 등 관련법을 위배하지 않는 범위내에서 이 약관을 개정할 수 있습니다.

  ③ 회사는 약관을 개정할 경우 그 개정이유 및 적용일자를 명시하여 현행 약관과 함께 적용일자 7일전부터 적용일 전일까지 제1항의 방법으로 공지합니다. 다만, 회원의 권리 또는 의무에 관한 중요한 규정의 변경은 최소한 30일 전에 공지하고 개정약관을 회원 이 등록한 메일(e-mail) 또는 이와 유사한 방법을 통해 발송하여 통지합니다.

  ④ 회사가 2항 및 3항에 따라 개정약관을 공지 또는 통지하면서 회원에게 공지일 또는 통지일로부터 30일 내에 거부의사를 표시하지 않으면 의사표시가 표명된 것으로 봅니다.

  ⑤ 개정된 약관을 공지 또는 통지하였음에도 불구하고, 회원이 명시적으로 거부의사를 표시하지 아니하는 경우, 회원이 개정약관에 동의한 것으로 봅니다. 회원은 변경된 약관에 동의하지 않을 경우 회원 탈퇴(해지)를 요청할 수 있습니다.
