...
public class OneDayView extends RelativeLayout {
    ...
    private void init(Context context)
    {
        ...
        View v = View.inflate(context, R.layout.calendar_oneday, this);
    ...
    */
    ...
    public void refresh() {
        ...
        if(one.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY) {
            dayTv.setTextColor(Color.rgb(255, 98, 98));
        }
        else if(one.get(Calendar.DAY_OF_WEEK) == Calendar.SATURDAY) {
            dayTv.setTextColor(Color.rgb(14, 82, 252));
        }
        else {
            dayTv.setTextColor(Color.rgb(182, 182, 182));
        }
