 ...
 */
public class LeftSlideBitmap extends ImageView {
    // Default Values
    ...
    public LeftSlideBitmap(final Context context) {
        this(context, null);
    }

    public LeftSlideBitmap(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.circularImageViewStyle);
    }

    public LeftSlideBitmap(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LeftSlideBitmap(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
